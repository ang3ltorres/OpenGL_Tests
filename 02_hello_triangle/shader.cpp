...
template <> void Shader::setValue<mat4>(const std::string &name, mat4 v) { glUniformMatrix4fv(glGetUniformLocation(id, name.data()), 1, false, value_ptr(v)); }
template <> void Shader::setValue<mat3>(const std::string &name, mat3 v) { glUniformMatrix3fv(glGetUniformLocation(id, name.data()), 1, false, value_ptr(v)); }
template <> void Shader::setValue<mat2>(const std::string &name, mat2 v) { glUniformMatrix2fv(glGetUniformLocation(id, name.data()), 1, false, value_ptr(v)); }

template <> void Shader::setValue<vec4>(const std::string &name, vec4 v) { glUniform4fv(glGetUniformLocation(id, name.data()), 1, value_ptr(v)); }
template <> void Shader::setValue<vec3>(const std::string &name, vec3 v) { glUniform3fv(glGetUniformLocation(id, name.data()), 1, value_ptr(v)); }
template <> void Shader::setValue<vec2>(const std::string &name, vec2 v) { glUniform2fv(glGetUniformLocation(id, name.data()), 1, value_ptr(v)); }
