...
int main() {
	...
	Shader shader("../03_texture/shaders/vertex.vert", "../03_texture/shaders/fragment.frag", "../03_texture/shaders/geometry.geom");
	Texture txr("../03_texture/ISO_C++_Logo.svg", 96.0f);
